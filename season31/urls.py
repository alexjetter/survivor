...
urlpatterns = [
	...
	url(r'^tribe/(?P<pk>[0-9]+)/$', views.TribeView.as_view(), name='tribe'),
	url(r'^updatescores/(?P<season_id>[0-9]+)/$', views.updatescores, name='updatescores'),
	url(r'^addepisode/(?P<season_id>[0-9]+)/$', views.addepisode, name='addepisode'),
