...
urlpatterns = [
	...
	url(r'^player/(?P<pk>[0-9]+)/jsps/$', views.PlayerJSPView.as_view(), name='playerjsps'),
	...
	url(r'^episode/(?P<pk>[0-9]+)/jsps/$', views.EpisodeJSPView.as_view(), name='episodejsps'),
	...
	url(r'^rolloverepisodeteams/(?P<e_id>[0-9]+)/$', views.rolloverepisodeteams, name='rolloverepisodeteams'),
	...
	url(r'^tallyepisodejsps/(?P<e_id>[0-9]+)/$', views.tallyepisodejsps, name='tallyepisodejsps'),
